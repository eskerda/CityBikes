package net.homelinux.penecoptero.android.openvelib.receivers;

import java.util.HashMap;
import java.util.Map;

import net.homelinux.penecoptero.android.openvelib.app.MainActivity;
import net.homelinux.penecoptero.android.openvelib.app.R;
import net.homelinux.penecoptero.android.openvelib.app.RESTHelper;
...
public class C2DMReceiver extends BroadcastReceiver {
	private static final int OPENVELIB_PUSH_ID = 1;
	...
	public void onReceive(Context context, Intent intent) {
		...
		if ("com.google.android.c2dm.intent.REGISTRATION".equals(action)) {
			...
			try{
				...
				CharSequence contentTitle = "openVelib station ready!";
				...
				mNotificationManager.notify(OPENVELIB_PUSH_ID, notification);
		}
	}
}
